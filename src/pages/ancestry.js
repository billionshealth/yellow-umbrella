      ...
      <section className="mid flex flex-col justify-center px-100">
        <div className="flex flex-col justify-center m-auto">
          ...
          <div className="flex flex-col mx-auto xl:w-5/12">
            <button
              href="#"
              className=" rounded-full m-5 sm:text-xs sm:p-2 md:p-2 md:text-md  xl:p-3 px-6 text-white bg-orange-400 baseline transition delay-150 ease-in-out hover:-translate-y-1 hover:scale-110 duration-300  border-2"
            >
