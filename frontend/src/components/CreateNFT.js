  ...
  return (
    <>
      <section id="dataUpload" className="w-full">
        <div className="container  flex flex-col items-center justify-center px-6 mx-auto">
          <form className="mt-6" onSubmit={submit}>
            ...
            <div className="container flex-row space-x-6 mt-10 text-center text-lightGray ">
              <a
                href="/ancestry"
                target="_blank"
                className="rounded-full p-3 bg-darkGray baseline 
                hover:duration-300 shadow-btns duration-300 hover:text-midGray  
      ...
      <section id="mintNFT" className="flex justify-center ">
        <div
          className="container flex-col justify-center items-center px-6 mx-auto 
        csm:!px-[0%] min-w-full"
        >
          {!fileUploaded && (
            <div
              id="canvas"
              className="flex mx-auto mt-8 csm:px-[9%] csm:!mx-0 cmd:px-[6.5%] 
